...
async function add504DayVolatility() {
    ...
    `).all() as { series_name: string }[];
      ...
      `);
            ...
            transaction();
            console.log(`  Inserted ${insertCount} 504-day volatility data points`);
        }

        console.log('\n✅ 504-day volatility calculation complete!');
...
// Run the script
add504DayVolatility().catch(console.error);

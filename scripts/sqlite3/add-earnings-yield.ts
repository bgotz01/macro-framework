...
function addEarningsYield() {
  ...
  metadataStmt.run(
    ...
    'Earnings-Yield',
    'Earnings Yield (10yr)',
    'Earnings Yield based on Shiller CAPE (1/PE ratio) - Inverse of 10-year cyclically adjusted P/E ratio',
  ...
  const sampleStmt = db.prepare(`
    ...
    FROM time_series
    WHERE asset_class = 'valuations' AND series_name = 'Earnings-Yield' AND column_name = 'Value'
    ORDER BY date DESC
    LIMIT 5
  `);

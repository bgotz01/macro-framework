...
export type ChartType = 'yields' | 'economics' | 'equities' | 'valuations' | 'fx' | 'returns' | 'volatility' | 'stocks' | 'percentile' | 'divergence' | 'all';
...
const CHART_TYPES: Array<{ value: ChartType; label: string; description: string }> = [
    ...
    },
    {
        value: 'valuations',
        label: 'Valuations',
        description: 'P/E ratios and valuation metrics'
    },
    {
        value: 'fx',
        label: 'FX & Currencies',
    ...
    },
    {
        value: 'divergence',
        label: 'MA Divergence',
        description: 'S&P 500 price divergence from moving averages'
    },
    {
        value: 'all',
        label: 'All Data',

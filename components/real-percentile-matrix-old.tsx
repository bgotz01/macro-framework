...
interface RealPercentileMatrixOldProps {
    initialValues: PercentileValues;
    sliderValue: number;
    onSliderChange: (value: number) => void;
}

export default function RealPercentileMatrixOld({ initialValues, sliderValue, onSliderChange }: RealPercentileMatrixOldProps) {

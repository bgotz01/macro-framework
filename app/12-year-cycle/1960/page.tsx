...
export default function Cycle1960Page() {
    return (
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            <h1 className="page-title text-4xl font-bold mb-6">1960 — Institutional Capital & Brand Consolidation</h1>
            <p className="text-lg text-muted-foreground mb-8">Theme: Permanence as an investment thesis</p>

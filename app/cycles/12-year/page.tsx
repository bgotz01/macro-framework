export default function TwelveYearCyclePage() {
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <h1 className="text-4xl font-bold mb-6">12-Year Cycle</h1>

            <div className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">Watch what happens every ~12 years after 1972</h2>
            ...
            <div className="space-y-6">
                <div className="p-6 rounded-lg border-2 border-border bg-card">
                    ...
                    <ul className="list-disc list-inside space-y-1 mb-3">
                        <li>Credit replaces reserves</li>
                        <li>Inflation risk introduced structurally</li>
                        <li>Central banks gain asymmetric power</li>
                        <li>Long-term debt cycles become possible</li>
                    </ul>
                ...
                <div className="p-6 rounded-lg border-2 border-border bg-card">
                    ...
                    <ul className="list-disc list-inside space-y-1 mb-3">
                        ...
                        <li>Leverage normalized</li>
                        <li>Capital mobility accelerates</li>
                    </ul>
                ...
                <div className="p-6 rounded-lg border-2 border-border bg-card">
                    ...
                    <ul className="list-disc list-inside space-y-1 mb-3">
                        ...
                        <li>Electronic markets</li>
                        <li>Network-native software</li>
                        <li>Capital velocity explodes</li>
                    </ul>
                ...
                <div className="p-6 rounded-lg border-2 border-border bg-card">
                    ...
                    <ul className="list-disc list-inside space-y-1 mb-3">
                        <li>Credit crisis</li>
                        <li>QE replaces market clearing</li>
                        <li>Risk socialized</li>
                        <li>States absorb fragility</li>
                    </ul>
                ...
                <div className="p-6 rounded-lg border-2 border-border bg-card">
                    ...
                    <ul className="list-disc list-inside space-y-1 mb-3">
                        <li>Direct transfers to households</li>
                        <li>Monetary + fiscal merge</li>
                        <li>Asset inflation decouples from labor</li>
                        <li>Trust vs control tension emerges</li>
                    </ul>
                    <p className="italic text-muted-foreground">This is fiat becoming behavioral, not just financial.</p>
                </div>
            </div>
        </div>
    );
